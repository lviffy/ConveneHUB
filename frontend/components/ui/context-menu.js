...
const ContextMenuSubTrigger = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.SubTrigger, _extends({
  ref: ref,
...
const ContextMenuSubContent = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.SubContent, _extends({
  ref: ref,
...
const ContextMenuContent = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.Portal, null, React.createElement(ContextMenuPrimitive.Content, _extends({
  ref: ref,
...
const ContextMenuItem = React.forwardRef(({
  ...
  inset,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.Item, _extends({
  ref: ref,
...
const ContextMenuCheckboxItem = React.forwardRef(({
  ...
  checked,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.CheckboxItem, _extends({
  ref: ref,
...
const ContextMenuRadioItem = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.RadioItem, _extends({
  ref: ref,
  className: cn("relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)
}, props), React.createElement("span", {
  className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"
...
const ContextMenuLabel = React.forwardRef(({
  ...
  inset,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.Label, _extends({
  ref: ref,
...
const ContextMenuSeparator = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(ContextMenuPrimitive.Separator, _extends({
  ref: ref,
