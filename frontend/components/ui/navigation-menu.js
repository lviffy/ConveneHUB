...
const NavigationMenu = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(NavigationMenuPrimitive.Root, _extends({
  ref: ref,
  className: cn("relative z-10 flex max-w-max flex-1 items-center justify-center", className)
}, props), children, React.createElement(NavigationMenuViewport, null)));
NavigationMenu.displayName = NavigationMenuPrimitive.Root.displayName;
const NavigationMenuList = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(NavigationMenuPrimitive.List, _extends({
  ref: ref,
...
const NavigationMenuTrigger = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(NavigationMenuPrimitive.Trigger, _extends({
  ref: ref,
  className: cn(navigationMenuTriggerStyle(), "group", className)
}, props), children, " ", React.createElement(ChevronDown, {
...
const NavigationMenuContent = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(NavigationMenuPrimitive.Content, _extends({
  ref: ref,
...
const NavigationMenuIndicator = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(NavigationMenuPrimitive.Indicator, _extends({
  ref: ref,
