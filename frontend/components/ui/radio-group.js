...
const RadioGroup = React.forwardRef(({
  ...
  return React.createElement(RadioGroupPrimitive.Root, _extends({
...
const RadioGroupItem = React.forwardRef(({
  ...
  return React.createElement(RadioGroupPrimitive.Item, _extends({
    ref: ref,
  ...
  }, props), React.createElement(RadioGroupPrimitive.Indicator, {
