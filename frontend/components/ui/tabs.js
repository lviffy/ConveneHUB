...
const TabsList = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(TabsPrimitive.List, _extends({
  ref: ref,
...
const TabsTrigger = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(TabsPrimitive.Trigger, _extends({
  ref: ref,
...
const TabsContent = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(TabsPrimitive.Content, _extends({
  ref: ref,
