...
const Menubar = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Root, _extends({
  ref: ref,
...
const MenubarTrigger = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Trigger, _extends({
  ref: ref,
...
const MenubarSubTrigger = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(MenubarPrimitive.SubTrigger, _extends({
  ref: ref,
...
}, props), children, React.createElement(ChevronRight, {
...
const MenubarSubContent = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(MenubarPrimitive.SubContent, _extends({
  ref: ref,
...
const MenubarContent = React.forwardRef(({
  ...
  sideOffset = 8,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Portal, null, React.createElement(MenubarPrimitive.Content, _extends({
  ref: ref,
  align: align,
...
const MenubarItem = React.forwardRef(({
  ...
  inset,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Item, _extends({
  ref: ref,
...
const MenubarCheckboxItem = React.forwardRef(({
  ...
  checked,
  ...props
}, ref) => React.createElement(MenubarPrimitive.CheckboxItem, _extends({
  ref: ref,
...
const MenubarRadioItem = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => React.createElement(MenubarPrimitive.RadioItem, _extends({
  ref: ref,
  className: cn("relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)
}, props), React.createElement("span", {
  className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"
...
const MenubarLabel = React.forwardRef(({
  ...
  inset,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Label, _extends({
  ref: ref,
...
const MenubarSeparator = React.forwardRef(({
  className,
  ...props
}, ref) => React.createElement(MenubarPrimitive.Separator, _extends({
  ref: ref,
