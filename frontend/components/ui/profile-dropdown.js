...
export default function ProfileDropdown({
  ...
  return React.createElement("div", {
  ...
  }, userCity)), React.createElement("div", {
  ...
  }, userInitial))), React.createElement(AnimatePresence, null, isOpen && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: -10,
      scale: 0.95
    ...
    className: "h-4 w-4 text-gray-500"
  }), React.createElement("span", null, "Profile")), React.createElement("div", {
