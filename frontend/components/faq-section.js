...
const faqs = [{
  ...
  answer: "ConveneHub is an all-in-one event management platform for organizers, promoters, and attendees. It centralizes event publishing, ticketing, check-ins, and reporting in one workflow."
}, {
  question: "How does multi-campus event management work?",
  answer: "You can manage multiple campuses or tenants from a single admin view while keeping each event, team assignment, and performance report organized by location."
}, {
  question: "Is attendee and organizer data secure?",
  answer: "Security is a top priority. ConveneHub uses secure authentication, role-based access controls, and protected APIs to safeguard booking, attendee, and financial data."
}, {
  question: "Can smaller organizers use ConveneHub?",
  answer: "Absolutely. ConveneHub is built for both high-volume events and smaller teams, so clubs, colleges, and communities can run events with the same reliability as larger organizers."
}, {
  question: "How do check-ins work on event day?",
  answer: "Each booking includes a QR ticket that event staff can scan at the venue. This enables faster entry, real-time attendance updates, and fewer manual errors."
}, {
  question: "Can I migrate from existing tools?",
  answer: "Yes. Our onboarding process helps teams move event and attendee workflows from disconnected tools into ConveneHub with minimal disruption."
}];
