...
export default function MovieTeamDashboard({
  ...
  }, "You have not created any events yet. Once you create one, it will appear here.")) : React.createElement("div", {
  ...
  }, "Live Stats")))))))))), activeTab === "live-dash" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
  ...
  }, "Please select an event to add notes")))))))), selectedEvent && React.createElement(CheckinModal, {
