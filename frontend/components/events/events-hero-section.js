...
export default function EventsHeroSection() {
  ...
  return React.createElement("section", {
    ...
    "aria-hidden": "true"
  }), isMounted && React.createElement("video", {
    ref: videoRef,
    autoPlay: true,
    loop: true,
    muted: true,
  ...
  }), "Live Event Experiences", React.createElement("div", {
    className: "w-8 xs:w-10 h-[1px] bg-white/40"
  })), React.createElement("div", {
  ...
  }, "Plan, Book,"), React.createElement(motion.span, {
    initial: false,
    animate: {
      opacity: 1
    },
  ...
  }, "Attend")), React.createElement(motion.p, {
    initial: false,
    animate: {
      opacity: 1
    },
  ...
  }, "Discover curated events near you, book in seconds, and walk in with secure QR-based entry."), React.createElement(motion.div, {
    initial: false,
    animate: {
      opacity: 1,
      y: 0
  ...
  }, date ? date : "Select Date"), React.createElement("input", {
    ref: dateInputRef,
    type: "date",
    value: date,
  ...
  }, genre ? GENRES.find(g => g.value === genre)?.label : "Category"), React.createElement(ChevronDown, {
    className: `w-4 h-4 text-gray-400 transition-transform duration-200 ${isGenreOpen ? "rotate-180" : ""}`
  })), React.createElement(AnimatePresence, null, isGenreOpen && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: -10,
      scale: 0.95
    ...
    className: "py-1"
  }, GENRES.map(g => React.createElement("button", {
    key: g.value,
    type: "button",
    onClick: () => {
      setGenre(g.value);
  ...
  }, React.createElement("span", null, g.label), genre === g.value && React.createElement(Check, {
    className: "w-4 h-4"
  }))))))), React.createElement(Button, {
    ...
    className: "sm:hidden"
  }, "Search")))), React.createElement(motion.div, {
    initial: false,
    animate: {
      opacity: 1
    },
  ...
  }, "Explore Events"), React.createElement("div", {
