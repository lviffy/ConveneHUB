...
import { Search, MapPin, Calendar, Film, ChevronDown, Check } from "lucide-react";
...
export default function EventsHeroSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "relative w-full min-h-[calc(100vh-10px)] rounded-b-[20px] md:rounded-b-[24px] overflow-hidden flex flex-col items-center justify-center bg-white border-x border-b border-gray-100"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    "aria-hidden": "true"
  }), isMounted && /*#__PURE__*/React.createElement("video", {
    ref: videoRef,
    autoPlay: true,
    loop: true,
    muted: true,
    ...
    className: "relative z-10 mx-auto max-w-5xl px-4 xs:px-5 sm:px-6 py-24 xs:py-28 sm:py-32"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }), "Live Event Experiences", /*#__PURE__*/React.createElement("div", {
    className: "w-8 xs:w-10 h-[1px] bg-white/40"
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Plan, Book,"), /*#__PURE__*/React.createElement(motion.span, {
    initial: false,
    animate: {
      opacity: 1
    },
  ...
  }, "Attend")), /*#__PURE__*/React.createElement(motion.p, {
    initial: false,
    animate: {
      opacity: 1
    },
  ...
  }, "Discover curated events near you, book in seconds, and walk in with secure QR-based entry."), /*#__PURE__*/React.createElement(motion.div, {
    initial: false,
    animate: {
      opacity: 1,
      y: 0
    ...
    className: "inline-flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-0 bg-white border border-gray-200 rounded-2xl sm:rounded-full p-3 sm:p-2 shadow-sm max-w-3xl w-full sm:w-auto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2 px-4 py-2 sm:border-r border-gray-200"
  ...
  }, date ? date : "Select Date"), /*#__PURE__*/React.createElement("input", {
    ref: dateInputRef,
    type: "date",
    value: date,
  ...
  }, genre ? GENRES.find(g => g.value === genre)?.label : "Category"), /*#__PURE__*/React.createElement(ChevronDown, {
    className: `w-4 h-4 text-gray-400 transition-transform duration-200 ${isGenreOpen ? "rotate-180" : ""}`
  })), /*#__PURE__*/React.createElement(AnimatePresence, null, isGenreOpen && /*#__PURE__*/React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: -10,
      scale: 0.95
  ...
  }, /*#__PURE__*/React.createElement("span", null, g.label), genre === g.value && /*#__PURE__*/React.createElement(Check, {
    className: "w-4 h-4"
  }))))))), /*#__PURE__*/React.createElement(Button, {
    ...
    className: "sm:hidden"
  }, "Search")))), /*#__PURE__*/React.createElement(motion.div, {
    initial: false,
    animate: {
      opacity: 1
    },
