...
export default function EventsListSection() {
  ...
  if (events.length === 0) {
    ...
    }, "No Events Available"), /*#__PURE__*/React.createElement("p", {
      className: "text-sm xs:text-base text-gray-600"
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, filteredEvents.length, " ", filteredEvents.length === 1 ? "event" : "events", " available"))), hasFilters && /*#__PURE__*/React.createElement("div", {
    className: "mb-4 flex flex-wrap items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-500 mr-1"
  }, "Filters:"), locationFilter && /*#__PURE__*/React.createElement("span", {
    className: "inline-flex items-center gap-1 px-3 py-1.5 bg-gray-900 text-white text-xs font-medium rounded-full"
  }, /*#__PURE__*/React.createElement(MapPin, {
    className: "w-3 h-3"
  }), locationFilter), dateFilter && /*#__PURE__*/React.createElement("span", {
    className: "inline-flex items-center gap-1 px-3 py-1.5 bg-gray-900 text-white text-xs font-medium rounded-full"
    ...
    month: "short",
    day: "numeric"
  })), genreFilter && /*#__PURE__*/React.createElement("span", {
    className: "inline-flex items-center gap-1 px-3 py-1.5 bg-gray-900 text-white text-xs font-medium rounded-full"
  }, /*#__PURE__*/React.createElement(Film, {
    className: "w-3 h-3"
  }), genreFilter), /*#__PURE__*/React.createElement("button", {
    ...
    return /*#__PURE__*/React.createElement(motion.div, {
    ...
    }, event.status.replace("_", " ").toUpperCase())), /*#__PURE__*/React.createElement("p", {
      ...
      className: "w-3.5 h-3.5 xs:w-4 xs:h-4 flex-shrink-0"
    }), /*#__PURE__*/React.createElement("span", null, isSoldOut ? "Sold Out" : `${event.remaining} ${event.remaining === 1 ? "slot" : "slots"} left`))), /*#__PURE__*/React.createElement("div", {
      className: "flex flex-wrap gap-2 pl-0 xs:pl-0 md:pl-13"
    }, event.remaining > 0 && event.remaining <= 10 && /*#__PURE__*/React.createElement("span", {
      className: "inline-flex items-center px-2.5 py-1 text-[10px] xs:text-xs font-medium bg-gray-900 text-white rounded-full"
    }, "Limited to ", event.capacity, " Visitors"), (event.venue_name?.toLowerCase().includes("outdoor") || event.venue_name?.toLowerCase().includes("garden") || event.venue_name?.toLowerCase().includes("beach") || event.venue_name?.toLowerCase().includes("park")) && /*#__PURE__*/React.createElement("span", {
    ...
    }, "Outdoor Scene"), event.ticket_price === 0 && /*#__PURE__*/React.createElement("span", {
      className: "inline-flex items-center px-2.5 py-1 text-[10px] xs:text-xs font-medium bg-green-100 text-green-700 rounded-full"
    }, "Free Entry"), fillPercentage >= 70 && fillPercentage < 100 && /*#__PURE__*/React.createElement("span", {
    ...
    }, "Filling Fast")), /*#__PURE__*/React.createElement("div", {
    ...
    }, "FREE") : `₹${event.ticket_price.toLocaleString("en-IN")}`)), /*#__PURE__*/React.createElement("div", {
    ...
    }, booked, "/", event.capacity)))), /*#__PURE__*/React.createElement("div", {
    ...
    }, isSoldOut ? /*#__PURE__*/React.createElement("span", null, "Sold Out") : isBooked ? /*#__PURE__*/React.createElement("span", {
      className: "flex items-center gap-2"
    }, /*#__PURE__*/React.createElement(CheckCircle2, {
      className: "w-4 h-4"
    }), "View Booking") : /*#__PURE__*/React.createElement("span", {
      className: "flex items-center gap-2"
  ...
  })), filteredEvents.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "text-center py-16 xs:py-20"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "No events in ", selectedCity), /*#__PURE__*/React.createElement("p", {
    className: "text-sm xs:text-base text-gray-600 mb-4 xs:mb-6"
  }, "Try selecting a different city"), /*#__PURE__*/React.createElement(Button, {
