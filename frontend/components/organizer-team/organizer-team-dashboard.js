...
export default function MovieTeamDashboard({
  ...
  return React.createElement("div", {
  ...
  }, sidebarLinks.map((link, idx) => React.createElement("div", {
    key: idx,
  ...
  }, link.icon), React.createElement(motion.span, {
    initial: false,
    animate: {
  ...
  }, profile.full_name.charAt(0).toUpperCase()), React.createElement(motion.div, {
    initial: false,
    animate: {
      width: sidebarOpen ? "auto" : 0,
      opacity: sidebarOpen ? 1 : 0
  ...
  }, profile.full_name), React.createElement("div", {
    className: "text-xs text-neutral-500 truncate"
  }, profile.city))), React.createElement("div", {
  ...
  }, "Event Operations Dashboard"), React.createElement("p", {
    className: "text-sm sm:text-base text-gray-600"
  }, "Manage check-ins, live updates, and your events")), React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    className: "space-y-6"
  }, activeTab === "events" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    className: "text-xl"
  }, "My Events"), React.createElement(CardDescription, {
    className: "mt-1"
  }, "View and manage events created by you")))), React.createElement(CardContent, {
    className: "p-6"
  ...
  }, "Loading your events...")) : error ? React.createElement("div", {
    className: "text-center py-16"
  }, React.createElement("div", {
  ...
  }, "Error Loading Events"), React.createElement("p", {
    className: "text-gray-500 max-w-sm mx-auto mb-4"
  }, error), React.createElement(Button, {
    onClick: fetchOrganizerEvents,
    variant: "outline"
  }, "Try Again")) : organizerEvents.length === 0 ? React.createElement("div", {
    className: "text-center py-16"
  }, React.createElement("div", {
  ...
  }, "You have not created any events yet. Once you create one, it will appear here."), React.createElement(Button, {
    className: "mt-4",
  ...
  }, organizerEvents.map(event => React.createElement(motion.div, {
    key: event.event_id,
    initial: {
      opacity: 0,
      y: 20
  ...
  }, event.title), getStatusBadge(event.status)), React.createElement(CardDescription, {
    className: "line-clamp-2"
  }, event.description)), React.createElement(CardContent, {
    className: "space-y-3"
  }, React.createElement("div", {
  ...
  }, format(new Date(event.date_time), "PPP p"))), React.createElement("div", {
    className: "flex items-start gap-2 text-sm"
  ...
  }, event.venue_name), React.createElement("div", {
    ...
    className: "text-gray-600"
  }, event.remaining, " / ", event.capacity, " spots available")), React.createElement("div", {
    className: "pt-3 border-t border-gray-100"
  }, React.createElement("p", {
    className: "text-xs text-gray-500"
  }, "Created: ", format(new Date(event.assigned_at), "PPP"))), React.createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-3 gap-2"
  }, isCheckinAvailable(event.date_time, event.status) ? React.createElement(Button, {
  ...
  }, event.status === "ended" ? "Event has ended" : `Opens in ${getTimeUntilCheckin(event.date_time)}`, React.createElement("div", {
  ...
  }, "Live Stats")))))))))), activeTab === "create-event" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    className: "text-xl"
  }, "Create New Event"), React.createElement(CardDescription, {
    className: "mt-1"
  }, "Create and publish your own event with VIP and General ticket tiers"))), React.createElement(CardContent, {
    className: "p-6"
  }, React.createElement(CreateEventForm, {
    userId: profile.id,
    actorRole: "organizer",
    successRedirectPath: "/organizer"
  })))), activeTab === "reconciliation" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
  ...
  }, React.createElement(ReconciliationDashboard, {
    apiBasePath: "/api/organizer"
  })), activeTab === "live-dash" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
  ...
  }, organizerEvents.length > 0 ? React.createElement("div", {
    className: "space-y-6"
  }, [...organizerEvents].sort((a, b) => new Date(b.date_time).getTime() - new Date(a.date_time).getTime()).map(event => React.createElement(LiveDashboard, {
    key: event.event_id,
    ...
    className: "text-lg font-semibold text-gray-900 mb-2"
  }, "No Events"), React.createElement("p", {
    className: "text-gray-500 max-w-sm mx-auto mb-4"
  }, "Create an event first to see live stats."), React.createElement(Button, {
    onClick: () => setActiveTab("events")
  }, "View My Events")))), activeTab === "on-ground-notes" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    className: "text-xl"
  }, "On-Ground Notes"), React.createElement(CardDescription, {
    className: "mt-1"
  }, "Add feedback, incident remarks, or important observations")))), React.createElement(CardContent, {
    className: "p-6"
  }, React.createElement("div", {
    className: "space-y-4"
  ...
  }, "Select Event"), React.createElement("div", {
    className: "relative"
    ...
    value: "",
    className: "text-gray-500"
  }, "-- Select an event --"), organizerEvents.map(event => React.createElement("option", {
    key: event.event_id,
    value: event.event_id,
    className: "text-gray-900 py-2"
  }, event.title, " - ", format(new Date(event.date_time), "MMM d, yyyy")))), React.createElement("div", {
    ...
    strokeWidth: 2.5,
    d: "M19 9l-7 7-7-7"
  }))))), selectedEvent && React.createElement(React.Fragment, null, React.createElement("div", null, React.createElement("label", {
    htmlFor: "event-notes",
    className: "block text-sm font-medium text-gray-700 mb-2"
  }, "Event Notes & Feedback"), React.createElement("textarea", {
    id: "event-notes",
    value: onGroundNotes,
  ...
  })), notesSaved && React.createElement("div", {
    className: "bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg"
  }, "\u2713 Notes saved successfully!"), notesError && React.createElement("div", {
    className: "bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg"
  }, "\u2717 ", notesError), React.createElement(Button, {
    onClick: handleSaveNotes,
    disabled: savingNotes,
    className: "bg-[#195ADC] hover:bg-[#1450c0] text-white"
  }, React.createElement(StickyNote, {
    className: "mr-2 h-4 w-4"
  }), savingNotes ? "Saving..." : "Save Notes")), !selectedEvent && React.createElement("div", {
    className: "text-center py-8 text-gray-500"
  }, "Please select an event to add notes"))))), activeTab === "settings" && React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    className: "text-xl"
  }, "Settings"), React.createElement(CardDescription, {
    className: "mt-1"
  }, "Configure your organizer preferences"))), React.createElement(CardContent, {
    className: "p-6"
  }, React.createElement("div", {
    className: "text-center py-16"
  }, React.createElement("div", {
    ...
    className: "text-gray-500 max-w-sm mx-auto"
  }, "Settings panel coming soon.")))))))), selectedEvent && React.createElement(CheckinModal, {
