...
} = require('../services/referrals.service');

const bookingsRouter = Router();
const BOOKING_ALLOWED_ROLES = ['attendee', 'admin', 'organizer', 'promoter'];

function toLegacyBooking(booking, event) {
  return {
...
async function syncAttendeeRecord(eventId, attendeeId) {
